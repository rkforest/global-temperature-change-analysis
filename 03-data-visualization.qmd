...
This step creates visualizations to show how temperature anomalies have changed.  
  -  Global Time Series
  -  Climate Period Comparisons
     -  Temperature Distributions  
     -  Hemisphere Differences 
     -  Geographic Latitude Zone Differences  
...
sf_gridded <- read_rds(file.path(dir_transformed,"gridded.rds"))
```

#### Coastline

```{r}
#| label: import-coastline
sf_coastline <- sf::read_sf(file.path(dir_raw,"global-coastline.gpkg"))
```

### Climate periods labels
